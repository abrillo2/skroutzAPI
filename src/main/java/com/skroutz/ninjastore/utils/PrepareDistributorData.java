...
public class PrepareDistributorData {
    ...
    private final String bigbuyUrl;
    ...
    private List<Map<String, String>> percentageList;
    
    
    public PrepareDistributorData(String xtgUrl,String wwtUrl, String mobiUrl,String bigbuyUrl){
        
        this.xtgUrl = xtgUrl;
        this.wwtUrl = wwtUrl;
        this.mobiUrl = mobiUrl;
        this.bigbuyUrl = bigbuyUrl;
     ...
     */
     public  Map<String,List<Map<String, String>>> getDistributorData() throws CustomException {
            ...
            //get category percetnges
            this.percentageList = this.getCategoryPercentage();
           ...
           // List<Map<String, String>> xtgData = parseProductXmlDistributor(xtgProductDomKey,eanList,xtgUrl,"ean","coming",true,"XTG");
            ...
            /**
             * 
             * Prepare BIG BUY DATA
             * 
             */
            List<Map<String, String>> bigBuyData=new ArrayList<>();
           if(bigbuyUrl !=null){
                currentDistributors.add("BIGBUY");
                PrePareBigBuyDistributor pbgd = new PrePareBigBuyDistributor(bigbuyUrl,eanList);
                pbgd.extractDataBigBuy();
                bigBuyData = pbgd.getBigBuyData();
           }
    ...
    public void updateProductStock() throws IOException{
        ...
        for(Map<String, String> ninjaData : ninjaStoreData){
            ...
            String nPrice = ninjaData.get("price_with_vat");
            String nCategory = ninjaData.get("category");
            nMpn = nMpn !=null?nMpn:"";
            nDistributor = nDistributor !=null?nDistributor:"";
            nPrice = nPrice !=null?nPrice:"";
            nCategory = nCategory !=null?nCategory:"";
            ...
            if(dEanList.contains(nEan)){
                ...
                //generate nsPrice from disPrice
                //String[] generatedPrice = HelperClass.generateProductPrice(disPrice, nPrice, nCategory, percentageList);
                
                //update ninja store xml data
                ninjaData.put("quantity", dStock);
                ninjaData.put("distributor", dis);
                ninjaData.put("disPrice", disPrice);
                //ninjaData.put("price_with_vat", generatedPrice[0]);
                //ninjaData.put("priceAutoGenerated", generatedPrice[1]);
    ...
    /**
     * Get List of rates for each category
     * @return 
     */
    private List<Map<String, String>> getCategoryPercentage() {
        String fileUri = docFolder+"/rate list.xlsx";
        List<Map<String, String>> rateList = new ArrayList<>();
        try{
           ExcelReader er = new ExcelReader(fileUri,new String[]{"category","rate"});
           rateList = er.readExcel();
            return rateList;
        }catch(Exception e){
